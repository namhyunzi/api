...
/*
 * 날짜와 시간 관련 유용한 메소드를 제공하는 클래스다.
 */
public class DateUtils {
	
	private static final SimpleDateFormat basicFormat
	     = new SimpleDateFormat("yyyy.MM.dd");
	private static final SimpleDateFormat detailFormat
