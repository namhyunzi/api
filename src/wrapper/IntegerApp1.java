...
public class IntegerApp1 {
	...
	public static void main(String[] args) {
		 ...
		 *  			전달받은 정수를 8진수로 구성된 문자열로 반한한다.
		 *  		static String toHexString(int i)
		 *  			전달받은 정수를 16진수로 구성된 문자열로 반한한다.
		 *  
		 ...
		 *  			전달받은 정수를 포함하는 Integer 객체의 주소값을 반환한다.
		 *  		static Integer valueOf(String str)
		 *  			정수(전달받은 문자열이 표현하는)를 포함하는 Integer 객체의 주소값을 반환한다.
		 *  		static Integer valueOf(String str, int radix)
		 *  			정수(전달받은 문자열이 표현하는)를 포함하는 Integer 객체의 주소값을 반환한다.
		 *  
		 *  	멤버 메소드
		 *   	    int intValue()
		 *   			Integer 객체가 가지고 있는 정수값을 반환한다.
